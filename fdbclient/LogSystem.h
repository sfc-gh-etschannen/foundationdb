...
struct ILogSystem {
	...
	static Reference<ILogSystem> fromClientDBInfo( UID const& dbgid, struct ClientDBInfo const& db, bool useRecoveredAt = false, Optional<PromiseStream<Future<Void>>> addActor = Optional<PromiseStream<Future<Void>>>() );
